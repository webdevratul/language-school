...
const Services = () => {
    ...
    return (
        <div className="w-[100%] md:w-[90%] mx-auto flex flex-col xl:flex-row justify-between items-center m-5 xl:m-10 2xl:pl-16">
            <div className="w-[80%] md:w-[50%] xl:w-[30%] mb-10 xl:mb-0" data-aos="fade-down-right">
            ...
            <div className="px-4 md:px-0 grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-4 w-[100%] xl:w-[60%]" data-aos="fade-zoom-in">

                {
                    services.map((service, idx) => <div key={idx} className=" bg-yellow-50 rounded-lg shadow-2xl p-4 cursor-pointer" data-aos="flip-left"
