...
const Packages = () => {
    return (
        <div className="py-10 mx-auto bg-[#F6F6F6]">
            <h2 className="text-center text-2xl md:text-4xl xl:text-6xl font-bold my-20">Premium Price Packages</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-[90%] lg:w-[60%] mx-auto gap-x-4 mb-14">
                <div className=" flex flex-col gap-y-4 bg-white py-14 px-6 cursor-pointer rounded-lg shadow-2xl mb-4 xl:mb-0" data-aos="zoom-in-up">
                ...
                <div className=" flex flex-col gap-y-4 bg-yellow-50 py-14 px-6 cursor-pointer rounded-lg shadow-2xl mb-4 xl:mb-0" data-aos="zoom-in-up">
                ...
                <div className=" flex flex-col gap-y-4 bg-white py-14 px-6 cursor-pointer rounded-lg shadow-2xl" data-aos="zoom-in-up">
