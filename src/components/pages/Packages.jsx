    ...
    return (
        <div className="py-10 mx-auto bg-[#F6F6F6]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-[90%] lg:w-[60%] mx-auto gap-x-4 mb-14">
                <div className=" flex flex-col gap-y-4 bg-white py-14 px-6 cursor-pointer rounded-lg shadow-2xl mb-4 xl:mb-0">
                ...
                <div className=" flex flex-col gap-y-4 bg-yellow-50 py-14 px-6 cursor-pointer rounded-lg shadow-2xl mb-4 xl:mb-0">
