...
const Navbar = () => {
    ...
    const navLink = <>
        ...
        <li className="mx-1"><NavLink to="/subscribe">Subscribe</NavLink></li>
        {
            user &&
            <>
                <li className="mx-1"><NavLink to="/profile">Profile</NavLink></li>
                <li className="mx-1"><NavLink to="/setting">Settings</NavLink></li>
            </>
        }
    </>
    ...
    return (
        <div className="">
            ...
            <div className="navbar bg-base-100 mx-auto shadow-lg 2xl:px-20 py-4">
                ...
                <div className="navbar-end flex flex-col md:flex-row item-center pl-4 lg:pl-0">
                    {
                        user ? <div className="flex flex-col md:flex-row items-center px-4">
                            ...
                            <img className="w-[40px] h-[40px] rounded-full object-cover ml-1 my-2 md:my-0 cursor-pointer" src={user.photoURL} alt="" />
                        </div>
